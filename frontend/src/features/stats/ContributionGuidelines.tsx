/**
 * Contribution guidelines accordion - how to name files/folders so ProxyPrints indexes them
 * correctly (tags, languages, card types, ignored files). Unrelated to the `catalogComposition`
 * cache/aggregate panels on this page (this is onboarding doc content for image *source*
 * contributors, not a catalog statistic) - moved verbatim from the old `pages/contributions.tsx`
 * (now a redirect shell, see that file's own comment) as part of the /stats transform, per the
 * owner's brief to preserve what the old contributions page did well rather than drop it.
 */
