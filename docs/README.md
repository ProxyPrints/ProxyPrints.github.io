...
| [`proposals/pipeline-batching-and-verdict-transfer.md`](proposals/pipeline-batching-and-verdict-transfer.md) — Stage E streaming pipeline batching rework + MD5 verdict transfer                                                                                                                                                                                                                                                                                                          | SHIPPED  |
