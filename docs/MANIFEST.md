...
| `pipeline-worker-orientation.md`        | low-token bootstrap for Stage C / extractor work: governing posture, extractor pattern, PROTECTED CORE, golden-set convention — read instead of the full catalog-completion-plan.md            | Stage C extractor work specifically                           | reference  |
