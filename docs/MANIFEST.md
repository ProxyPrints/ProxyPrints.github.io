...
| `pipeline-fidelity-gate.md`             | canonical status page for the pipeline-fidelity gate (GitHub issue #154): artifact 1/2 status, the two open owner decisions, verified data snapshot                                            | Stage D full-catalog fire go/no-go                            | BINDING    |
...
| `data/`                                 | dated JSON pipeline snapshots + provenance `.md` siblings, for chart/infographic generation (homepage-panel's reserved slot)                                                                   | none (data record only)                                       | historical |
