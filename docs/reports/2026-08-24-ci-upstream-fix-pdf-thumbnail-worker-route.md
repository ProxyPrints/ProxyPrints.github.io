```
TASK: Upstream branch verification (automated) — upstream-fix-pdf-thumbnail-worker-route
Ref checked: upstream-fix-pdf-thumbnail-worker-route @ eee2db42260751bfeb214f11a686164848236d5c
...
```
connection/base.py:200: ElasticsearchWarning: Elasticsearch built-in security features are not enabled. Without authentication, your cluster could be accessible to anyone. See https://www.elastic.co/guide/en/elasticsearch/reference/7.17/security-minimal-setup.html to enable security.
...
=========== 8 failed, 241 passed, 52217 warnings in 64.21s (0:01:04) ===========
```
