```
TASK: Upstream branch verification (automated) — upstream-fix-pdf-canvas-preview
Ref checked: upstream-fix-pdf-canvas-preview @ c0d0acb3a138e0cdfd33d677eacf66477d6a99c8
...
=========== 8 failed, 241 passed, 52217 warnings in 62.04s (0:01:02) ===========
```
