...
```
stMTGIntegration::test_import_canonical_cards_and_artists[card with an expansion code not in db is skipped]
  /opt/hostedtoolcache/Python/3.13.15/x64/lib/python3.13/site-packages/sentry_sdk/integrations/logging.py:285: DeprecationWarning: datetime.datetime.utcfromtimestamp() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.fromtimestamp(timestamp, datetime.UTC).
...
=========== 6 failed, 243 passed, 52215 warnings in 65.26s (0:01:05) ===========
```
