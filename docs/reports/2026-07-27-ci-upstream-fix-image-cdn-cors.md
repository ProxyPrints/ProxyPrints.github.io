...
::test_comprehensive_snapshot
  /opt/hostedtoolcache/Python/3.13.14/x64/lib/python3.13/site-packages/django/db/models/fields/__init__.py:1595: RuntimeWarning: DateTimeField Card.date_modified received a naive datetime (2026-07-27 06:42:05.000871) while time zone support is active.
    warnings.warn(

cardpicker/tests/test_dfc_pairs.py::TestSyncDFCs::test_comprehensive_snapshot
  /opt/hostedtoolcache/Python/3.13.14/x64/lib/python3.13/site-packages/django/db/models/fields/__init__.py:1595: RuntimeWarning: DateTimeField Card.date_modified received a naive datetime (2026-07-27 06:42:05.000901) while time zone support is active.
    warnings.warn(
...
=========== 4 failed, 245 passed, 52213 warnings in 61.14s (0:01:01) ===========
```
