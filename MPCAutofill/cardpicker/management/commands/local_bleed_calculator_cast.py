...
class Command(BaseCommand):
    help = (
        ...
        "Negative-only, same convention as the existing bleed-edge-cast-v1 identity: votes "
        "only when this calculator's own reading agrees the card is 'trimmed'. Never resolves "
