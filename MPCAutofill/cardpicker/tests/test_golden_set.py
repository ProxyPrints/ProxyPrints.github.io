...
EXTRACTORS_WITHOUT_GOLDEN_EXPECTATIONS = {
    ...
    # set-narrowing (confidence 2), or border-table-tiebreak (confidence 2) - none of which is
    # owner-verified truth for the 30 golden cards, so there is nothing stable to pin yet.
    # Closing it needs the same real 30-card host-venv run against prod images the
    # artbox_phash/pinline_inset/art_edge waivers above defer.
    "frame_family",
}
