...
class PrintingCandidate(BaseModel):
    ...
    def from_dict(obj: Any) -> 'PrintingCandidate':
        ...
        return PrintingCandidate(artist, borderColor, canonicalId, collectorNumber, expansionCode, expansionName, frame, fullArt, identifier, isBorderless, isEtched, isExtendedArt, isShowcase, mediumThumbnailUrl, smallThumbnailUrl, artCropUrl, illustrationId, releasedAt)
...
class Card(BaseModel):
    ...
    def from_dict(obj: Any) -> 'Card':
        ...
        suggestedCanonicalCard = from_union([from_none, CanonicalCardClass.from_dict], obj.get("suggestedCanonicalCard"))
        suggestedCanonicalCardConfidence = from_union([from_none, from_float], obj.get("suggestedCanonicalCardConfidence"))
        suggestedFilterTagNames = from_union([from_none, lambda x: from_list(from_str, x)], obj.get("suggestedFilterTagNames"))
        tagVoteStatuses = from_union([lambda x: from_dict(TagVoteDisplayStatus, x), from_none], obj.get("tagVoteStatuses"))
        return Card(cardType, dateCreated, dateModified, dpi, extension, identifier, language, mediumThumbnailUrl, name, printingTagStatus, priority, searchq, size, smallThumbnailUrl, source, sourceId, sourceName, sourceVerbose, tags, bleedProvenance, canonicalArtist, canonicalArtistIsFromVoteOnly, canonicalArtistSource, canonicalCard, layout, measuredBleedMm, sourceExternalLink, sourceType, suggestedCanonicalCard, suggestedCanonicalCardConfidence, suggestedFilterTagNames, tagVoteStatuses)
    ...
    def to_dict(self) -> dict:
        ...
        if self.bleedProvenance is not None:
            result["bleedProvenance"] = from_union([lambda x: to_enum(BleedProvenance, x), from_none], self.bleedProvenance)
        ...
        if self.canonicalArtistIsFromVoteOnly is not None:
            result["canonicalArtistIsFromVoteOnly"] = from_union([from_bool, from_none], self.canonicalArtistIsFromVoteOnly)
        ...
        if self.suggestedCanonicalCard is not None:
            result["suggestedCanonicalCard"] = from_union([from_none, lambda x: to_class(CanonicalCardClass, x)], self.suggestedCanonicalCard)
        if self.suggestedCanonicalCardConfidence is not None:
            result["suggestedCanonicalCardConfidence"] = from_union([from_none, to_float], self.suggestedCanonicalCardConfidence)
        if self.suggestedFilterTagNames is not None:
            result["suggestedFilterTagNames"] = from_union([from_none, lambda x: from_list(from_str, x)], self.suggestedFilterTagNames)
        if self.tagVoteStatuses is not None:
            result["tagVoteStatuses"] = from_union([lambda x: from_dict(lambda x: to_enum(TagVoteDisplayStatus, x), x), from_none], self.tagVoteStatuses)
        return result
...
class QuestionFeedItem(BaseModel):
    ...
    def from_dict(obj: Any) -> 'QuestionFeedItem':
        ...
        discriminatingAxes = from_union([lambda x: from_list(DiscriminatingAx, x), from_none], obj.get("discriminatingAxes"))
        familyCandidates = from_union([lambda x: from_list(FrameFamilyCandidate.from_dict, x), from_none], obj.get("familyCandidates"))
        familyConfidence = from_union([from_none, from_float], obj.get("familyConfidence"))
        illustrationCandidates = from_union([lambda x: from_list(PrintingCandidate.from_dict, x), from_none], obj.get("illustrationCandidates"))
        ...
        return QuestionFeedItem(card, type, candidates, confidentlyKnownArtistName, discriminatingAxes, familyCandidates, familyConfidence, illustrationCandidates, isAnotherCopy, proposedFamilyDisplayName, proposedFamilyName, scryfallIllustrationUrl, suggestedPrinting, tagConfidence, tagName)
    ...
    def to_dict(self) -> dict:
        ...
        if self.candidates is not None:
            result["candidates"] = from_union([lambda x: from_list(lambda x: to_class(PrintingCandidate, x), x), from_none], self.candidates)
        ...
        if self.discriminatingAxes is not None:
            result["discriminatingAxes"] = from_union([lambda x: from_list(lambda x: to_enum(DiscriminatingAx, x), x), from_none], self.discriminatingAxes)
        if self.familyCandidates is not None:
            result["familyCandidates"] = from_union([lambda x: from_list(lambda x: to_class(FrameFamilyCandidate, x), x), from_none], self.familyCandidates)
        ...
        if self.illustrationCandidates is not None:
            result["illustrationCandidates"] = from_union([lambda x: from_list(lambda x: to_class(PrintingCandidate, x), x), from_none], self.illustrationCandidates)
        ...
        if self.suggestedPrinting is not None:
            result["suggestedPrinting"] = from_union([lambda x: to_class(PrintingCandidate, x), from_none], self.suggestedPrinting)
...
class ArtistCandidatesResponse(BaseModel):
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["results"] = from_list(lambda x: from_union([from_none, lambda x: to_class(CanonicalArtistClass, x)], x), self.results)
        return result
...
class ArtistConsensusResponse(BaseModel):
    ...
    def to_dict(self) -> dict:
        ...
        if self.resolvedArtist is not None:
            result["resolvedArtist"] = from_union([from_none, lambda x: to_class(CanonicalArtistClass, x)], self.resolvedArtist)
        return result
...
class FilterSettings(BaseModel):
    ...
    def from_dict(obj: Any) -> 'FilterSettings':
        ...
        return FilterSettings(borderlessOnly, excludesTags, fullArtOnly, includesTags, languages, maximumDPI, maximumSize, minimumDPI)
...
class Participation(BaseModel):
    ...
    def from_dict(obj: Any) -> 'Participation':
        ...
        total = from_int(obj.get("total"))
        return Participation(confirmable, contested, distinctCardsRoutedToReview, distinctCardsRoutedToReviewWithHumanVotes, distinctCardsWithHumanVotes, distinctHumanVoters, fresh, humanVotes, md5Groups, total)
...
class CatalogStatsResponse(BaseModel):
    ...
    def from_dict(obj: Any) -> 'CatalogStatsResponse':
        ...
        return CatalogStatsResponse(catalogComposition, contributionsOverTime, participation, runHistory, skipBreakdown, generatedAt)
...
class CryptoProfileResponse(BaseModel):
    ...
    def from_dict(obj: Any) -> 'CryptoProfileResponse':
        ...
        return CryptoProfileResponse(exists, kdfIterations, passphraseWrappedMasterKey, passphraseWrappedMasterKeyNonce, recoveryWrappedMasterKey, recoveryWrappedMasterKeyNonce, salt)
    ...
    def to_dict(self) -> dict:
        ...
        result["passphraseWrappedMasterKeyNonce"] = from_union([from_none, from_str], self.passphraseWrappedMasterKeyNonce)
...
class EditorSearchResponse(BaseModel):
    ...
    def from_dict(obj: Any) -> 'EditorSearchResponse':
        ...
        operatorErrors = from_union([lambda x: from_dict(lambda x: from_list(from_str, x), x), from_none], obj.get("operatorErrors"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.operatorErrors is not None:
            result["operatorErrors"] = from_union([lambda x: from_dict(lambda x: from_list(from_str, x), x), from_none], self.operatorErrors)
        return result
...
class PrintingConsensusResponse(BaseModel):
    ...
    def to_dict(self) -> dict:
        ...
        if self.resolvedPrinting is not None:
            result["resolvedPrinting"] = from_union([lambda x: to_class(PrintingCandidate, x), from_none], self.resolvedPrinting)
        return result
...
class SaveCryptoProfileRequest(BaseModel):
    ...
    def from_dict(obj: Any) -> 'SaveCryptoProfileRequest':
        ...
        return SaveCryptoProfileRequest(kdfIterations, passphraseWrappedMasterKey, passphraseWrappedMasterKeyNonce, recoveryWrappedMasterKey, recoveryWrappedMasterKeyNonce, salt)
...
class SavedDeckSummary(BaseModel):
    ...
    def from_dict(obj: Any) -> 'SavedDeckSummary':
        ...
        wrappedDek = from_str(obj.get("wrappedDek"))
        wrappedDekNonce = from_str(obj.get("wrappedDekNonce"))
        return SavedDeckSummary(ciphertext, ciphertextNonce, createdAt, key, kind, updatedAt, wrappedDek, wrappedDekNonce)
...
class SubmitIllustrationVoteResponse(BaseModel):
    ...
    def from_dict(obj: Any) -> 'SubmitIllustrationVoteResponse':
        ...
        illustrationId = from_union([from_none, from_str], obj.get("illustrationId"))
        resolvedPrinting = from_union([PrintingCandidate.from_dict, from_none], obj.get("resolvedPrinting"))
        return SubmitIllustrationVoteResponse(artistVoteCast, isUnknown, printingVoteCast, artistAbstainReason, illustrationId, resolvedPrinting)
