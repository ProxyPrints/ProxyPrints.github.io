...
class Card(BaseModel):
    canonicalArtistIsFromVoteOnly: bool
    ...
    def from_dict(obj: Any) -> "Card":
        assert isinstance(obj, dict)
        canonicalArtistIsFromVoteOnly = from_bool(obj.get("canonicalArtistIsFromVoteOnly"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["canonicalArtistIsFromVoteOnly"] = from_bool(self.canonicalArtistIsFromVoteOnly)
